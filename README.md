This is a reverse engineering of a Tesla Model 3 inverter current sensor block assembly and temp sensors for OpenInverter / EVBMW use.  This is a high voltage component, use this model at your own risk. If it fails it could inject high voltage into the board. Basically, if you dont know what you're doing, do not use this.
